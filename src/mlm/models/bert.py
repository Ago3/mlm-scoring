...
# PyTorch-based
from transformers import AlbertForMaskedLM, BertForMaskedLM, DistilBertForMaskedLM, RobertaForMaskedLM
...
class BertweetForMaskedLMOptimized(RobertaForMaskedLM):
